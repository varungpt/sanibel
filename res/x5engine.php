...
class ImComment
{
    ...
    /**
     * Save the comments in a DB. This method is available only in the Professional edition.
     *
     * @method saveToDb
     * 
...
class imPrivateArea
{
    ...
    /**
     * Setup the db connection. This method is only available in the Professional edition.
     *
     * @method setDBData
     * 
     * @param {string} $host
    ...
    /**
     * Register a new user in the database. This method is available only in the Professional edition.
     *
...
class ImTopic
{
    ...
    /**
     * Load the data from the database. This method is available only in the Professional edition.
     *
     * @method loadDb
     * 
    ...
    /**
     * Save the comments to a database. This method is available only in the Professional edition.
     *
     * @method saveDb
     * 
     * @param {string} $host  The dbname
