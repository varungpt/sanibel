...
<?php if (isset($imSettings['access']['entrancepage'])): ?>
		<a href="privatearea.php"<?php if (isset($_SERVER['PHP_SELF']) && basename($_SERVER['PHP_SELF']) == "privatearea.php") echo " class=\"active\""; ?>><?php echo l10n('private_area_title', 'Private Area') ?></a>
<?php endif; ?>
<?php if (isset($imSettings['ecommerce']) && isset($imSettings['ecommerce']['database'])): ?>
		<a href="orders.php"<?php if (isset($_SERVER['PHP_SELF']) && basename($_SERVER['PHP_SELF']) == "orders.php") echo " class=\"active\""; ?>><?php echo l10n('cart_title', 'E-Commerce') ?></a>
<?php endif; ?>
<?php if (isset($imSettings['dynamicobjects']) && count($imSettings['dynamicobjects'])): ?>
		<a href="dynamicobjects.php"<?php if (isset($_SERVER['PHP_SELF']) && basename($_SERVER['PHP_SELF']) == "dynamicobjects.php") echo " class=\"active\""; ?>><?php echo l10n('dynamicobj_name', 'Dynamic objects') ?></a>
<?php endif; ?>
